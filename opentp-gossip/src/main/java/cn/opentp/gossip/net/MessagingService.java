...
import cn.opentp.gossip.gms.GossipDigestAck2VerbHandler;
import cn.opentp.gossip.gms.GossipDigestAckVerbHandler;
import cn.opentp.gossip.gms.GossipDigestSynVerbHandler;
import cn.opentp.gossip.gms.GossipShutdownVerbHandler;
...
//    private final NonBlockingHashMap<InetSocketAddress, OutboundTcpConnectionPool> connectionManagers_ = new NonBlockingHashMap<InetSocketAddress, OutboundTcpConnectionPool>();
    private final Map<InetSocketAddress, OutboundTcpConnectionPool> connectionManagers_ = new ConcurrentHashMap<>();

    private List<SocketThread> socketThreads = new ArrayList<>();
...
//      MessagingService.instance().registerVerbHandlers(Verb.INTERNAL_RESPONSE, new ResponseVerbHandler());
        ...
        verbHandlers_.put(MessageVerb.Verb.GOSSIP_DIGEST_SYN, new GossipDigestSynVerbHandler());
        verbHandlers_.put(MessageVerb.Verb.GOSSIP_DIGEST_ACK, new GossipDigestAckVerbHandler());
        verbHandlers_.put(MessageVerb.Verb.GOSSIP_DIGEST_ACK2, new GossipDigestAck2VerbHandler());
        verbHandlers_.put(MessageVerb.Verb.GOSSIP_SHUTDOWN, new GossipShutdownVerbHandler());

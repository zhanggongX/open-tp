...
//            ArrayUtils.EMPTY_BYTE_ARRAY
    ...
    public void run() {
        while (true) {
            ...
            if (entry.timestamp < System.currentTimeMillis() - Gossiper.getRpcTimeout())
...
//        new Header(from, StorageService.VERBS[verbOrdinal]);
    ...
    private boolean connect() {
        ...
        while (System.currentTimeMillis() < start + Gossiper.getRpcTimeout()) {
            try {
//                socket = poolReference.newSocket();
    ...
    private void expireMessages() {
        while (true) {
            ...
            if (entry == null || entry.timestamp >= System.currentTimeMillis() - Gossiper.getRpcTimeout())
                break;

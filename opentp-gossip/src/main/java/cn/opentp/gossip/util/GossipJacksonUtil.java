...
import cn.opentp.gossip.node.jackson.GossipNodeKeyDeserializer;
import cn.opentp.gossip.node.jackson.GossipNodeKeySerializer;
...
public class GossipJacksonUtil {
    ...
    static {
        ...
        simpleModule.addKeySerializer(GossipNode.class, new GossipNodeKeySerializer());
        simpleModule.addKeyDeserializer(GossipNode.class, new GossipNodeKeyDeserializer());
